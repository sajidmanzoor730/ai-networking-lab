...
Spectrum, ConnectX, SONiC, Cumulus Linux, RDMA, RoCE v2, GPUDirect RDMA (studied, not hardware-validated), PFC, ECN, LACP 802.3ad, VLAN, Docker, Wireshark, tcpdump, iperf3, ethtool
...
See [VALIDATION_OUTPUT.md](./VALIDATION_OUTPUT.md) for the real output.
